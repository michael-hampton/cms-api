    ...
    <div class="spm-modal">
        ...
        <div class="spm-modal-body">
            ...
            <div class="spm-form-group">
                <label class="spm-form-label" for="spm-add-name-on-card">Name on card</label>
                <input type="text" id="spm-add-name-on-card" class="spm-text-input" data-spm-name-on-card="add"
            ...
            <div class="spm-form-group">
                ...
                <p class="spm-scope-note">Applies to future renewals only - it won't move subscriptions already assigned
                    to another card.</p>
            </div>
...
<div class="spm-modal-overlay" data-spm-modal="update" role="dialog" aria-modal="true"
     aria-labelledby="spm-update-title">
    <div class="spm-modal">
        <div class="spm-modal-header">
        ...
        <div class="spm-modal-body">
            ...
            <div class="spm-form-group">
                <label class="spm-form-label" for="spm-update-name-on-card">Name on card</label>
                <input type="text" id="spm-update-name-on-card" class="spm-text-input" data-spm-name-on-card="update"
                       autocomplete="cc-name" required>
            </div>
            <div class="spm-form-group">
            ...
            <div class="spm-form-group">
                ...
                <p class="spm-scope-note">Applies to future renewals only. Any subscriptions currently billing to the
                    old card will be moved to this new card automatically.</p>
            </div>
        </div>
        <div class="spm-modal-footer">
...
<!-- Remove Card Modal -->
<div class="spm-modal-overlay" data-spm-modal="remove" role="dialog" aria-modal="true"
     aria-labelledby="spm-remove-title">
    <div class="spm-modal">
        <div class="spm-modal-header">
...
<style>
    ...
    .spm-panel-subtitle {
        color: var(--spm-text-secondary, #6b7280);
        margin-top: 0.5rem;
    }
    ...
    .spm-btn-primary {
        background: var(--spm-primary, #667eea);
        color: #fff;
    }

    .spm-btn-primary:hover:not(:disabled) {
        background: var(--spm-primary-dark, #5568d3);
    }

    .spm-btn-secondary {
        background: #fff;
        color: var(--spm-text, #1f2937);
        border: 2px solid var(--spm-border, #e5e7eb);
    }

    .spm-btn-secondary:hover:not(:disabled) {
        border-color: var(--spm-primary, #667eea);
        color: var(--spm-primary, #667eea);
    }

    .spm-btn-danger {
        background: var(--spm-danger, #ef4444);
        color: #fff;
    }
    ...
    .spm-alert-warning {
        background: #fef3c7;
        color: #92400e;
        border-left: 4px solid var(--spm-warning, #f59e0b);
    }

    .spm-alert-error {
        background: #fee2e2;
        color: #991b1b;
        border-left: 4px solid var(--spm-danger, #ef4444);
    }
    ...
    .spm-card-logo {
        ...
        height: 36px;
        border-radius: 6px;
        background: var(--spm-bg, #f5f7fa);
        border: 1px solid var(--spm-border, #e5e7eb);
        display: flex;
        align-items: center;
    ...
    .spm-skeleton-row {
        ...
        animation: spm-shimmer 1.4s infinite;
    }
    ...
    .spm-checkbox-label input {
        width: 16px;
        height: 16px;
        accent-color: var(--spm-primary, #667eea);
    }
    ...
    .spm-modal-header {
        padding: 1.5rem;
        border-bottom: 1px solid var(--spm-border, #e5e7eb);
        display: flex;
        justify-content: space-between;
        align-items: center;
    }
    ...
    .spm-modal-footer {
        padding: 1.5rem;
        border-top: 1px solid var(--spm-border, #e5e7eb);
        display: flex;
        gap: 1rem;
