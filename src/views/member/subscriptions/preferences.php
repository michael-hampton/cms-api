...
<head>
    ...
    <title>Subscription Preferences - <?= htmlspecialchars($site->name) ?></title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<div class="container">
    ...
    <form method="POST" action="/<?= \App\Framework\Support\SiteContext::slug() ?>/member/subscriptions/preferences"
          id="preferencesForm">
        ...
        <div class="btn-group">
            ...
            <a href="/member/subscriptions" class="btn btn-secondary">
                Cancel
            </a>
        </div>
    </form>
