...
<div class="container">
    <div class="header">
        ...
        <p>Manage your subscription plans and preferences</p>
    </div>
            ...
            <?php else: ?>
                <div class="empty-state">
                    ...
                    <?php if (isset($plans) && $plans->count() > 0): ?>
                        <?php $firstPlan = $plans->first(); ?>
                        <button class="btn btn-primary"
                                onclick="quickSubscribe('<?= htmlspecialchars($firstPlan->slug) ?>', this)">
                            Subscribe to <?= htmlspecialchars($firstPlan->name) ?>
                        </button>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
