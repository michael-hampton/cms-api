...
$feedPages = Page::with(['categories', 'tags', 'authors', 'products', 'comments'])
        ->orderByDesc('created_at')
        ->limit(10)
        ->get();

if ($feedPages->isEmpty()) return;
...
<style>
    ...
    .activity-feed-card {
        ...
        max-height: 700px; /* Limits the entire widget height */
    ...
    .activity-feed-scroll-area::-webkit-scrollbar {
        width: 6px;
    }

    .activity-feed-scroll-area::-webkit-scrollbar-thumb {
        background: #d1d5db;
        border-radius: 10px;
    }
