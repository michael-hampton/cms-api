 ...
 *
 * @var object $page - The page object
    ...
    <?php if ($showToolbar): ?>
        <div class="page-card-actions-ribbon">
            <button class="action-btn" onclick="toggleShareDropdown(this)" title="Share">
                ...
                <div class="share-dropdown" onclick="event.stopPropagation()">
                    <div class="share-option"
                         onclick="shareToFacebook('/<?= \App\Framework\Support\SiteContext::slug() ?><?= htmlspecialchars($page->getUrlAttribute()) ?>')">
                    ...
                    <div class="share-option"
                         onclick="shareToTwitter('/<?= \App\Framework\Support\SiteContext::slug() ?><?= htmlspecialchars($page->getUrlAttribute()) ?>', '<?= htmlspecialchars($page->title) ?>')">
                        <div class="share-option-icon">
                    ...
                    <div class="share-option"
                         onclick="shareToLinkedIn('/<?= \App\Framework\Support\SiteContext::slug() ?><?= htmlspecialchars($page->getUrlAttribute()) ?>')">
                        <div class="share-option-icon">
                    ...
                    <div class="share-option"
                         onclick="shareToWhatsApp('/<?= \App\Framework\Support\SiteContext::slug() ?><?= htmlspecialchars($page->getUrlAttribute()) ?>', '<?= htmlspecialchars($page->title) ?>')">
                        <div class="share-option-icon">
                    ...
                    <div class="share-option"
                         onclick="shareToReddit('/<?= \App\Framework\Support\SiteContext::slug() ?><?= htmlspecialchars($page->getUrlAttribute()) ?>', '<?= htmlspecialchars($page->title) ?>')">
                        <div class="share-option-icon">
                    ...
                    <div class="share-option"
                         onclick="copyLink('/<?= \App\Framework\Support\SiteContext::slug() ?><?= htmlspecialchars($page->getUrlAttribute()) ?>')">
                        <div class="share-option-icon">
            ...
            <button class="action-btn"
                    onclick="openCommentModal('/<?= \App\Framework\Support\SiteContext::slug() ?><?= htmlspecialchars($page->getUrlAttribute()) ?>', '<?= $page->id ?>')"
                    title="Comment">
                <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2">
