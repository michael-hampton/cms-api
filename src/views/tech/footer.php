    ...
    <div class="footer-container">
        <div class="footer-main">
            <div class="footer-section footer-brand">
                ...
                <p class="footer-tagline">Empowering developers and tech enthusiasts with cutting-edge insights.</p>
                <div class="footer-social">
                    ...
                    <a href="#" class="footer-social-link" aria-label="RSS">
                        <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24"><path d="M6.503 20.752c0 1.794-1.456 3.248-3.251 3.248-1.796 0-3.252-1.454-3.252-3.248 0-1.794 1.456-3.248 3.252-3.248 1.795.001 3.251 1.454 3.251 3.248zm-6.503-12.572v4.811c6.05.062 10.96 4.966 11.022 11.009h4.817c-.062-8.71-7.118-15.758-15.839-15.82zm0-3.368c10.58.046 19.152 8.594 19.183 19.188h4.817c-.03-13.231-10.755-23.954-24-24v4.812z"/></svg>
                    </a>
                </div>
            </div>
            ...
            <div class="footer-section">
                ...
                <ul class="footer-links">
                    ...
                    <li><a href="/mobile">Mobile Dev</a></li>
            ...
            <div class="footer-section">
                ...
                <p class="footer-newsletter-text">Get weekly tech insights delivered to your inbox.</p>
        ...
        <div class="footer-bottom">
            <p class="footer-copyright">&copy; <?= date('Y') ?> TechWeekly. All rights reserved.</p>
