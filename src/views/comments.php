...
<?php if ($page->metadata?->allow_comments == 1 || $page->page_type === 'blog'): ?>
                    ...
                    <article class="comment-card" data-comment-id="<?= $comment->id ?>">
                        ...
                        <div class="comment-body">
                            <div class="comment-meta">
                                <h4 class="comment-author"><?= htmlspecialchars($comment->name) ?></h4>
        ...
        (function () {
            ...
            document.addEventListener('click', function (e) {
                if (e.target.closest('.reply-btn')) {
                    ...
                    const authorName = commentCard.querySelector('.comment-author').textContent;
