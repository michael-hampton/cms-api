...
<?php
/**
 * Template: open-collab/admin/payouts/index.blade.php
 *
...
$extraScripts = ($extraScripts ?? '') . "\n"
        . '<script src="' . asset('open-collab/widgets/oc-admin-payouts-widget.js', 'js') . '"></script>';
$extraScripts = ($extraScripts ?? '') . "\n"
...
<div data-open-collab-surface="<?= htmlspecialchars($surface ?? 'admin.payouts.index') ?>">
...
@section('scripts')
<script>
    window.OPEN_COLLAB_SURFACE = <?= json_encode($surface ?? 'admin.payouts.index') ?>;
