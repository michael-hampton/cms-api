...
class CuratesNewsletterDemoSeeder
{
    ...
    {
        $layout = NewsletterLayout::where('slug', 'curates-template-a')->first();

        Newsletter::updateOrCreate(
            [
                'slug' => 'curates-weekly-' . $siteId,
                'site_id' => $siteId,
            ],
            [
                ...
                // -------------------------------------------------------------------
                // Generic chrome / footer / editorial config.
                // buildTemplate() reads every key here without knowing which template
                // triggered it. Any newsletter can use any subset.
                // -------------------------------------------------------------------
                'design_config' => [
                    ...
                    'chrome' => [
                        ...
                        'show_nav' => true,
                        'nav_links' => [
                            ['label' => 'FASHION', 'url' => 'https://example.com/fashion'],
                            ['label' => 'BEAUTY', 'url' => 'https://example.com/beauty'],
                            ['label' => 'LIFESTYLE', 'url' => 'https://example.com/lifestyle'],
                            ['label' => 'SHOPPING', 'url' => 'https://example.com/shopping'],
                        ],
                    ],

                    'editorial' => [
                        'note' => "This week's edit is all about quiet luxury — the pieces that don't shout but always get noticed. From the shirt dress that works three ways to the earrings every fashion editor has already ordered, we've done the scrolling so you don't have to.",
                        'editor_name' => 'Sophie Ashworth',
                        'editor_title' => 'Fashion & Style Director',
                        'editor_image_url' => 'https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?w=80&h=80&fit=crop&crop=face',
                    ],

                    'footer' => [
                        'background' => '#f5f5f5',
                        'text_color' => '#888888',
                        'address' => '750 N. San Vicente Blvd, 8th Floor East, West Hollywood, CA 90069',
                        'social_links' => [
                        ...
                        'legal_links' => [
                            ...
                            ['label' => 'MANAGE SUBSCRIPTIONS', 'url' => '{{MANAGE_URL}}'],
                ...
                // -------------------------------------------------------------------
                // Content blocks — all standard registered types.
                // -------------------------------------------------------------------
                'content_blocks' => [
