...
/**
 * Seeds the "Curates Masthead" layout — empty center slots.
 *
 * This is the base layout definition only. Center slots are intentionally
 * empty — editors populate them via the UI, or demo seeders populate them
 * directly by creating a NewsletterLayoutVersion with blocks.
 *
 * Uses the improved rendering pipeline:
 *   - bannerType: 'masthead'     → structural header renderer
 *   - bannerType: 'footer-legal' → structural footer renderer
 *   - {{variable}} syntax        → resolved by LayoutBlockVariableResolver
 *
 * Run before CuratesMastheadDemoSeeder.
 */
