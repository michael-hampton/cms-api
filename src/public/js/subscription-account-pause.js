(() => {
    ...
    const initialise = () => {
        ...
        // Keep the original class/state controller, but move the overlay out of
        // the member account stacking context. A child z-index cannot escape an
        // ancestor stacking context, which is why increasing the dialog z-index
        // alone had no effect.
