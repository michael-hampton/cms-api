...
class RiskMarkerServiceTest extends TestCase
{
    ...
    public function test_create_runs_in_transaction_audits_and_dispatches_event(): void
    {
    ...
    public function test_create_without_actor_does_not_audit(): void
    {
    ...
    public function test_create_does_not_dispatch_event_if_transaction_throws(): void
    {
        $this->database->shouldReceive('transaction')
            ->once()
