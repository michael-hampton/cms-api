...
class AdminContractControllerTest extends FunctionalTestCase
{
    ...
    public function test_index_returns_all_contracts_for_site(): void
    {
        Contract::create([
            'site_id' => $this->siteId,
            'version' => 1,
            'content' => 'First contract content here for testing.',
            'created_at' => date('Y-m-d H:i:s'),
        ]);
        Contract::create([
            'site_id' => $this->siteId,
            'version' => 2,
            'content' => 'Second contract content here for testing.',
            'created_at' => date('Y-m-d H:i:s'),
        ]);
    ...
    public function test_latest_returns_highest_version_contract(): void
    {
        Contract::create([
            'site_id' => $this->siteId,
            'version' => 1,
            'content' => 'Old contract version content.',
            'created_at' => date('Y-m-d H:i:s'),
        ]);
        Contract::create([
            'site_id' => $this->siteId,
            'version' => 2,
            'content' => 'Newest contract version content.',
            'created_at' => date('Y-m-d H:i:s'),
        ]);
    ...
    public function test_show_returns_contract_by_id(): void
    {
        $contract = Contract::create([
            'site_id' => $this->siteId,
            'version' => 1,
            'content' => 'Full contract content for viewing.',
            'created_at' => date('Y-m-d H:i:s'),
        ]);
