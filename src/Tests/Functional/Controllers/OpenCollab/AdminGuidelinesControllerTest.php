...
class AdminGuidelinesControllerTest extends FunctionalTestCase
{
    ...
    public function test_index_returns_all_guideline_versions_for_site(): void
    {
        Guideline::create([
            'site_id' => $this->siteId,
            'version' => 1,
            'content' => 'First guidelines version content for testing.',
            'created_at' => date('Y-m-d H:i:s'),
        ]);
        Guideline::create([
            'site_id' => $this->siteId,
            'version' => 2,
            'content' => 'Second guidelines version content for testing.',
            'created_at' => date('Y-m-d H:i:s'),
        ]);
    ...
    public function test_latest_returns_highest_version_guideline(): void
    {
        Guideline::create([
            'site_id' => $this->siteId,
            'version' => 1,
            'content' => 'Original brand guidelines content here.',
            'created_at' => date('Y-m-d H:i:s'),
        ]);
        Guideline::create([
            'site_id' => $this->siteId,
            'version' => 2,
            'content' => 'Updated brand guidelines content here.',
            'created_at' => date('Y-m-d H:i:s'),
        ]);
    ...
    public function test_show_returns_guideline_by_id(): void
    {
        $guideline = Guideline::create([
            'site_id' => $this->siteId,
            'version' => 1,
            'content' => 'Full guidelines content for individual viewing.',
            'created_at' => date('Y-m-d H:i:s'),
        ]);
        ...
        $this->assertEquals('Full guidelines content for individual viewing.', $data['data']['guideline']['content']);
    }
    ...
    public function test_show_returns_404_for_guideline_on_different_site(): void
    {
        ...
        $guideline = Guideline::create([
            ...
            'version' => 1,
            'content' => 'Other site guidelines content.',
            'created_at' => date('Y-m-d H:i:s'),
        ]);
    ...
    public function test_store_creates_guideline_with_auto_incremented_version(): void
    {
        Guideline::create([
            'site_id' => $this->siteId,
            'version' => 1,
            'content' => 'Existing v1 guidelines content.',
            'created_at' => date('Y-m-d H:i:s'),
        ]);
