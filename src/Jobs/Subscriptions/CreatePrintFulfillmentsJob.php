 ...
 *
 * Sits between TriggerPrintRunWorkflowJob (creates PrintRun) and
 * CreateFulfilmentsChunkJob (creates individual fulfillment records).
 *
 * TriggerPrintRunWorkflowJob dispatches this job immediately after
 * creating the PrintRun, keeping itself thin and testable.
 *
...
class CreatePrintFulfillmentsJob extends BaseJob
{
    ...
    public function handle(int $printRunId, int $issueDeliveryId,
    ): void
    {
