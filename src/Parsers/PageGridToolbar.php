...
trait PageGridToolbar
{
    public function generateToolbar()
    {
        $html = '<div class="page-card-actions-ribbon">
        <button class="action-btn" onclick="toggleShareDropdown(this)" title="Share">
            ...
            <div class="share-dropdown" onclick="event.stopPropagation()">
                <div class="share-option" onclick="shareToFacebook(\'https://example.com/page\')">
                ...
                <div class="share-option" onclick="shareToTwitter(\'https://example.com/page\', \'Check out this page!\')">
                    <div class="share-option-icon">
                ...
                <div class="share-option" onclick="shareToLinkedIn(\'https://example.com/page\')">
                    <div class="share-option-icon">
                ...
                <div class="share-option" onclick="shareToWhatsApp(\'https://example.com/page\', \'Check out this page!\')">
                    <div class="share-option-icon">
                ...
                <div class="share-option" onclick="shareToReddit(\'https://example.com/page\', \'Check out this page!\')">
                    <div class="share-option-icon">
                ...
                <div class="share-option" onclick="copyLink(\'https://example.com/page\')">
                    <div class="share-option-icon">
        ...
        <button class="action-btn" onclick="openCommentModal(\'https://example.com/page\', \'1\')" title="Comment">
            <svg viewBox="0 0 24 24">
