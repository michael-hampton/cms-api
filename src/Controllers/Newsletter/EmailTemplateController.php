...
class EmailTemplateController extends Controller
{
    ...
    public function update(int $id, UpdateEmailTemplateRequest $request): JsonResponse
    {
        try {
            ...
            return $this->errorResponse($e->getMessage(), str_contains($e->getMessage(), 'not found') ? 404 : 500);
        }
    }
    ...
    {
        try {
            $result = $this->service->previewSaved($id, (string)$request->query('dataset', 'mock_order'));
