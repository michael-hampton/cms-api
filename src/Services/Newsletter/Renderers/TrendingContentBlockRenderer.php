...
class TrendingContentBlockRenderer implements EmailBlockRenderer
{
    public string $type = 'trending_content';
    ...
    {
        if (!$blockData instanceof TrendingContentBlockData) {
    ...
    private function buildHtml(TrendingContentBlockData $blockData, array $articles): string
    {
        ...
        foreach ($articles as $article) {
            $html[] = $this->renderArticleCard(
                $article,
                $blockData->showImage,
                $blockData->showExcerpt
            );
        }
