...
use App\Mail\OpenCollab\OnboardingStartedMail;
use App\Models\User;

final class OnboardingStartedNotification extends OpenCollabUserNotification
    implements EmailableNotification
{
    ...
    {
        return "Let's finish setting up your contributor account";
    }

    public function toMailable(): Mailable
    {
        return new OnboardingStartedMail($this->contributor);
    }
}